...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert(
            array(
                array('username' => 'admin', 'password' => Hash::make('password'), 'email' => 'webmaster@cl213.fr', 'google_id' => NULL, 'first_name' => 'Admin', 'last_name' => 'Istrateur', 'nickname' => '', 'info' => '[]', 'active' => 1, 'permissions' => '["admin"]'),
                array('username' => 'tarmak', 'password' => Hash::make('password'), 'email' => 'corentin.gitton@gadz.org', 'google_id' => '103503349814606129144', 'first_name' => 'Corentin', 'last_name' => 'Gitton', 'nickname' => 'Tarmak 154', 'info' => '[]', 'active' => 1, 'permissions' => '["admin"]'),
                array('username' => 'user1', 'password' => Hash::make('random'), 'email' => 'user1@gadz.org', 'google_id' => NULL, 'first_name' => 'User1', 'last_name' => 'User1', 'nickname' => 'User1', 'info' => '[]', 'active' => 0, 'permissions' => '["admin"]'),
                array('username' => 'user2', 'password' => Hash::make('random'), 'email' => 'user2@gadz.org', 'google_id' => NULL, 'first_name' => 'User2', 'last_name' => 'User2', 'nickname' => 'User2', 'info' => '[]', 'active' => 0, 'permissions' => '["admin"]'),
                array('username' => 'user3', 'password' => Hash::make('random'), 'email' => 'user3@gadz.org', 'google_id' => NULL, 'first_name' => 'User3', 'last_name' => 'User3', 'nickname' => 'User3', 'info' => '[]', 'active' => 0, 'permissions' => '["admin"]'),
                array('username' => 'user4', 'password' => Hash::make('random'), 'email' => 'user4@gadz.org', 'google_id' => NULL, 'first_name' => 'User4', 'last_name' => 'User4', 'nickname' => 'User4', 'info' => '[]', 'active' => 0, 'permissions' => '["admin"]'),
                array('username' => 'user5', 'password' => Hash::make('random'), 'email' => 'user5@gadz.org', 'google_id' => NULL, 'first_name' => 'User5', 'last_name' => 'User5', 'nickname' => 'User5', 'info' => '[]', 'active' => 0, 'permissions' => '["admin"]'),
                array('username' => 'user6', 'password' => Hash::make('random'), 'email' => 'user6@gadz.org', 'google_id' => NULL, 'first_name' => 'User6', 'last_name' => 'User6', 'nickname' => 'User6', 'info' => '[]', 'active' => 0, 'permissions' => '["admin"]'),
            ));
