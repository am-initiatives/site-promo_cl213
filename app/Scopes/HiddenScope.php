...
class HiddenScope implements ScopeInterface {
	...
	{
		$column = $model->getQualifiedHiddenColumn();
	...
	public function remove(Builder $builder, Model $model)
	{
		...
		{
			if ($this->isHiddenConstraint($where, $column))
			{
	 ...
	 * @return boolean
	 */
	protected function isHiddenConstraint(array $where, $column)
	{
